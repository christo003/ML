...
alpha,param_forest,idx_no_zero,m_lasso,std_lasso,m_forest,std_forest,reg_lasso=parameters['model_lasso'],parameters['param_forest'],parameters['idx_no_zero'],parameters['m_lasso'],parameters['std_lasso'],parameters['m_forest'],parameters['std_forest'],parameters['reg_lasso']
